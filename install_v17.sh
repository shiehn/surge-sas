...
echo "Force Installing Surge XT S&S Fork v1.7.0..."
echo ""
...
if strings "/Library/Audio/Plug-Ins/VST3/Surge XT.vst3/Contents/MacOS/Surge XT" | grep -q "S&S Fork v1.7.0"; then
    echo "✅ SUCCESS: S&S Fork v1.7.0 installed correctly!"
    echo ""
    ...
    echo "7. Click Settings menu - look for 'S&S Fork v1.7.0 (Smart Broker)'"
else
